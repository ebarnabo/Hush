  ...
  <div class="container mt-3 inactive vues animate__animated" id="inscription">
    <form @submit="inscription">
      ...
      <div class="d-flex justify-content-center mb-5">
        <button type="submit" class="btn btn-primary login-with-apple-btn mr-3" title="Connexion" onclick="Connexion()">S'inscrire avec Apple</button>
        <button type="submit" class="btn btn-primary login-with-google-btn" title="Connexion" onclick="Connexion()">S'inscrire avec Google</button>
      </div>
